...
class PayloadTest extends TestCase {
    ...
    public function testUriParametersHeadersAndQueryParams() {
        ...
        $this-> assertSame( $request-> datetimeHeader()->jsonSerialize(), "2011-08-01T10:07:04Z" );
        ...
        $this-> assertSame( $requester->lastHeaders()['datetime-header'][0], '2011-08-01T10:07:04Z' );
        ...
        $this-> assertSame( $response -> status200() -> datetimeHeader()->jsonSerialize(), "2011-08-01T10:07:04Z" );
        ...
        $this-> assertSame( $requester->getPath(), 'http://gateway/params/p1/params/array/p2/false/2011-08-01/10:07:04Z/2011-08-01T10:07:04Z' );
